...
/**
 * Model representing supply units types table
 *
 * @version 01 - Joseph Bosire 2013-06-08
 *
 * PHP version 5
 */
class Model_SupplyUnitType extends Model_Base {
	/**
	 * Model's table
	 * @string
	 */
	protected $_table_name = 'fpro_supply_unit_types';

	/**
	 * Model's primary key name
	 * @string
	 */
	protected $_primary_key = 'unit_type_id';

	public function get_supply_unit_types_list($search_field, $search_value){
